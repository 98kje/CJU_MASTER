...
#ifndef ROBOT_ARM_KEYBOARD_H_
#define ROBOT_ARM_KEYBOARD_H_
...
#include "robot_arm_msgs/SetJointPosition.h"
#include "robot_arm_msgs/SetKinematicsPose.h"
...
class RobotArmTeleop
{
  ...
  *****************************************************************************/
  ...
  void kinematicsPoseCallback(const robot_arm_msgs::KinematicsPose::ConstPtr &msg);
