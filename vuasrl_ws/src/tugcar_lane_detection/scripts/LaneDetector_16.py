...
def setup_path():
    path = "/home/kimjaen/vuasrl_ws/src/tugcar_lane_detection/source/KakaoTalk_20221007_063507621.mp4"
    cap=cv2.VideoCapture(path) #path
    return cap

def setup_countours():
    obj_b = cv2.imread('/home/kimjaen/vuasrl_ws/src/tugcar_lane_detection/source/corn_data/lavacorn_nb.png', cv2.IMREAD_GRAYSCALE)#wad
    obj_s = cv2.imread('/home/kimjaen/vuasrl_ws/src/tugcar_lane_detection/source/lavacorn_ns.png', cv2.IMREAD_GRAYSCALE)#wad
...
def starter():
    ...
    out = setup_output('/home/kimjaen/vuasrl_ws/src/tugcar_lane_detection/source/output_16_line.mp4', cap)
    setup_linear_reg()
