...
"""autogenerated by genpy from action_tutorial/MazeActionResult.msg. Do not edit."""
import codecs
import sys
...
class MazeActionResult(genpy.Message):
  ...
  _type = "action_tutorial/MazeActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_tutorial/MazeResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = action_tutorial.msg.MazeResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = action_tutorial.msg.MazeResult()
