...
let MazeGoal = require('./MazeGoal.js');
...
class MazeActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MazeGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.goal = MazeGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += MazeGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.goal !== undefined) {
      resolved.goal = MazeGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new MazeGoal()
    }
