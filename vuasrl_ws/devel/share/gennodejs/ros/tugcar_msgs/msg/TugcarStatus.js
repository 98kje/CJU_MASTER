...
class TugcarStatus {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TugcarStatus(null);
  ...
  static datatype() {
    ...
    return 'tugcar_msgs/TugcarStatus';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TugcarStatus(null);
