...
"""autogenerated by genpy from action_tutorial/MazeAction.msg. Do not edit."""
import codecs
import sys
...
class MazeAction(genpy.Message):
  _md5sum = "2f85e757afd277165669db9784e65ce5"
  _type = "action_tutorial/MazeAction"
...
"""
  ...
  _slot_types = ['action_tutorial/MazeActionGoal','action_tutorial/MazeActionResult','action_tutorial/MazeActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MazeAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = action_tutorial.msg.MazeActionGoal()
      if self.action_result is None:
        self.action_result = action_tutorial.msg.MazeActionResult()
      if self.action_feedback is None:
        self.action_feedback = action_tutorial.msg.MazeActionFeedback()
    else:
      self.action_goal = action_tutorial.msg.MazeActionGoal()
      self.action_result = action_tutorial.msg.MazeActionResult()
      self.action_feedback = action_tutorial.msg.MazeActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.action_goal.goal.turning_sequence)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.turning_sequence))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.action_goal.goal.turning_sequence = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_feedback.feedback.feedback_msg = str[start:end].decode('utf-8', 'rosmsg')
      else:
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(self.action_goal.goal.turning_sequence.tostring())
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      _x = self.action_result.header.frame_id
      length = len(_x)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_goal.goal.turning_sequence = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      _x = self
      start = end
      end += 12
      (_x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
