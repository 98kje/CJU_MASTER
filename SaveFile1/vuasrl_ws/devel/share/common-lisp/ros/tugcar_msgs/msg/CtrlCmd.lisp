...
(cl:defmethod cl:initialize-instance :after ((m <CtrlCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CtrlCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tugcar_msgs-msg:<CtrlCmd> is deprecated: use tugcar_msgs-msg:CtrlCmd instead.")))

(cl:ensure-generic-function 'longlCmdType-val :lambda-list '(m))
(cl:defmethod longlCmdType-val ((m <CtrlCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tugcar_msgs-msg:longlCmdType-val is deprecated.  Use tugcar_msgs-msg:longlCmdType instead.")
  (longlCmdType m))
...
(cl:defmethod steering-val ((m <CtrlCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tugcar_msgs-msg:steering-val is deprecated.  Use tugcar_msgs-msg:steering instead.")
  (steering m))
