...
(cl:defmethod cl:initialize-instance :after ((m <Demo_actionResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Demo_actionResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name master_ros-msg:<Demo_actionResult> is deprecated: use master_ros-msg:Demo_actionResult instead.")))

(cl:ensure-generic-function 'final_count-val :lambda-list '(m))
(cl:defmethod final_count-val ((m <Demo_actionResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader master_ros-msg:final_count-val is deprecated.  Use master_ros-msg:final_count instead.")
  (final_count m))
