...
(cl:in-package cpp_service_tutorial-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <ControlTurningMessage-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ControlTurningMessage-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cpp_service_tutorial-srv:<ControlTurningMessage-request> is deprecated: use cpp_service_tutorial-srv:ControlTurningMessage-request instead.")))

(cl:ensure-generic-function 'time_duration-val :lambda-list '(m))
(cl:defmethod time_duration-val ((m <ControlTurningMessage-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cpp_service_tutorial-srv:time_duration-val is deprecated.  Use cpp_service_tutorial-srv:time_duration instead.")
  (time_duration m))

(cl:ensure-generic-function 'angular_vel-val :lambda-list '(m))
(cl:defmethod angular_vel-val ((m <ControlTurningMessage-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cpp_service_tutorial-srv:angular_vel-val is deprecated.  Use cpp_service_tutorial-srv:angular_vel instead.")
  (angular_vel m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ControlTurningMessage-request>)))
  ...
  "cpp_service_tutorial/ControlTurningMessageRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ControlTurningMessage-request)))
  "Returns string type for a service object of type 'ControlTurningMessage-request"
  "cpp_service_tutorial/ControlTurningMessageRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ControlTurningMessage-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ControlTurningMessage-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cpp_service_tutorial-srv:<ControlTurningMessage-response> is deprecated: use cpp_service_tutorial-srv:ControlTurningMessage-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <ControlTurningMessage-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cpp_service_tutorial-srv:success-val is deprecated.  Use cpp_service_tutorial-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ControlTurningMessage-response>)))
  ...
  "cpp_service_tutorial/ControlTurningMessageResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ControlTurningMessage-response)))
  "Returns string type for a service object of type 'ControlTurningMessage-response"
  "cpp_service_tutorial/ControlTurningMessageResponse")
